...
const config = {
    ...
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '2250143875869',
    BOT_FOOTER: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇɴᴋɪ ᴏғғᴄ',
...
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/hpp7yv.jpg" },
        ...
        await socket.sendMessage(m.chat, {
            image: { url: "https://files.catbox.moe/xkexhr.jpg" },
            caption: `*🤖 ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ ᴀʟɪᴠᴇ*\n\n` +
                    `╭───────────────⭓\n` +
                    `│\n` +
...
╰───────────────`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363296159420895@newsletter',
                newsletterName: 'ᴅᴇɴᴋɪ ᴏғғɪᴄɪᴀʟ ᴄʜ',
                serverMessageId: -1
            }
        };

        await socket.sendMessage(from, {
            image: { url: "https://files.catbox.moe/eztx1h.jpg" },
            caption: captionText
        }, { 
            quoted: m,
...
`;
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/hpp7yv.jpg" },
      caption: `*ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: 'ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ',
                  rows: [
  ...
  break;
            ...
            case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363296159420895@newsletter'
                        });
                    }
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        const url = `https://den-mini-bot.onrender.com/code?number=${encodeURIComponent(number)}`;
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
`;
    ...
    await socket.sendMessage(sender, {
      image: { url: thumbnail || 'https://files.catbox.moe/eztx1h.jpg' }, // Fallback image
      caption
    }, { quoted: fakevCard });
                ...
                case 'winfo': {
                    ...
                    if (!args[0]) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Please give me a phone number, darling! Usage: .winfo 2250143xxxxxx',
                                'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇɴᴋɪ ᴏғғᴄ'
                            )
                        });
                        break;
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/eztx1h.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/xkexhr.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
`;
        ...
        const repoMessage = {
            image: { url: 'https://files.catbox.moe/3czirq.jpg' },
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || '120363296159420895@newsletter',
                    newsletterName: 'ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ',
                    serverMessageId: 143
                }
            }
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://github.com/denki-arch',
                sourceUrl: 'https://github.com/denki-arch'
            }
        }
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴅᴇɴ ᴍɪɴɪ ʙᴏᴛ
╭───────────────
